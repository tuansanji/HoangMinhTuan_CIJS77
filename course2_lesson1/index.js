...
// 3.Viết một chương trình lấy phần tử xuất hiện nhiều nhất trong một mảng và số lần suất hiện của nó trong mảng
    ...
    function getCount(arr) {
        ...
        for (let i = arr.length-1; i >= 0; --i) {
         ...
         let resultEnd = result.sort((a, b) => (a.numbers > b.numbers) ? -1 : 1).filter((item1, index1) => {
            return index1 == result.findIndex((item2) => {
    ...
    // console.log(getCount([1,23,3,4,5,6,7,8,8,5,5,6]));
